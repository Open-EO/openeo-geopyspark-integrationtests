from vegindex_calculator import *
import pytest, rasterio


@pytest.fixture
def auth_connection() -> openeo.Connection:
    """Connection fixture to a backend of given version with some image collections."""
    return openeo.connect("https://openeo-dev.vito.be").authenticate_basic("test","test123")
...
def test_vegindex_calculator_ndvi(auth_connection, index, bands, expected):
    x = 640860.000
    y = 5676170.000
    bbox = (x,y,x+20,y+20)
